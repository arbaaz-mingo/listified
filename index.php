	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-12 col-lg-9 col-xs-12 text-center">
				<div class="contents">
					<h1 class="head-title">Welcome to The Largest <span class="year">Classified</span></h1>
						...
						<div class="search-inner">
							<form class="search-form">
								<div class="form-group row">
									...
									<div class="col-sm-3">
										<button class="btn btn-search" type="submit"><i class="fas fa-search"></i> Search Now</button>
									</div>
								</div>
							</form>
						</div>
